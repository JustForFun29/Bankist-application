...
const headerObserver = new IntersectionObserver(stickyNav, {
  root: null,
  threshold: 0,
  rootMargin: `-${navHeight}px`, // important feature!
});
...
const allButtons = document.getElementsByTagName('button'); // HTML Collection - updates immediately!
